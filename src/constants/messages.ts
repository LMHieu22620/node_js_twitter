export const USERS_MESSAGES = {
  ...
  EMAIL_OR_PASSWORD_IS_INCORRECT: 'Email or password is incorect',
  ...
  RESEND_MAIL_VERIFY_SUCCESS: 'RESEND email verify success',
  RESEND_VERIFY_EMAIL_SUCCESS: 'Resend verify email success',
  EMAIL_FORGOT_PASSWORD_IS_REQUIRED: 'Email forgot password is required',
  CHECK_EMAIL_TO_RESET_PASSWORD: 'Check email to reset password',
  FORGOT_PASSWORD_VERIFY_TOKEN_IS_REQUIRED: 'Forgot password verify token is required',
